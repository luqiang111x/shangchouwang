                ...
                <div class="panel-body">
                    <form action="admin/save.html" method="post" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <input name="userPswd" type="text" class="form-control" id="exampleInputPassword1" placeholder="请输入的登录密码">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputPassword1">用户昵称</label>
                            <input name="userName" type="text" class="form-control" id="exampleInputPassword1" placeholder="请输入的用户昵称">
                        </div>
                        <div class="form-group">
